...
--
-- Host: localhost
-- Generation Time: 2016-10-17 14:39:29
-- 服务器版本： 5.6.11
-- PHP Version: 5.5.1
...
(2, '127.0.0.1', '2048', '10000', '2016-10-17 11:54:08', '1');
...
(1, 'admin', '###d2df176462c29cba4dcbdd421729547a', 'admin', 'B15011828@njupt.edu.cn', '', NULL, 0, NULL, NULL, '127.0.0.1', '2016-10-13 11:42:56', '2016-09-20 03:29:36', '', 1, 0, 1, 0, ''),
...
(3, 'njupt', '###d2df176462c29cba4dcbdd421729547a', '', 'ctygood@gmail.com', '', NULL, 0, NULL, NULL, '127.0.0.1', '2016-10-17 16:13:14', '2016-10-06 15:58:05', '', 1, 0, 1, 0, ''),
...
--
ALTER TABLE `check_auth_rule`
  MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT COMMENT '规则id,自增主键',AUTO_INCREMENT=167;
--
...
--
ALTER TABLE `check_commentstar`
  MODIFY `star_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
