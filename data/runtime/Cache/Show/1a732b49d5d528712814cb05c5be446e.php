 ...
 <a type="button" class="am-btn am-btn-success" href="/index.php/Show/index/video?id=<?php echo ($origincode); ?>">视频</a>
  <a type="button" class="am-btn am-btn-success" href="/index.php/Show/index/comment?id=<?php echo ($origincode); ?>">评分</a>
   <a type="button" class="am-btn am-btn-success" href="/index.php/Show/index/comp?id=<?php echo ($origincode); ?>">简介</a>
  			  ...
  			  <div class="info" style="height:250px;">
  			  		<div class="title docmap">
  			  			<img src="/public/image/8.png" class="titleimg">
          ...
          <div class="info" style="height:250px;overflow:hidden;">
              <div class="title"  style="background-color:rgb(24,114,222);">
                <img src="/public/image/11.png" class="titleimg">
              </div>
              <div>
                <div class="imgone">
                  <img src="/public/image/img1.jpg" class="oneimg">
                </div>
                 <div class="imgsecond">
                  <div class="imgtwo">
                    <img src="/public/image/img3.jpg" class="twoimg">
                  </div>
                 <div class="imgtwo">
                    <img src="/public/image/img2.jpg" class="twoimg">                
                 </div>
                <div class="imgtwo">
                    <img src="/public/image/img4.jpg" class="twoimg">                
                 </div>
               </div>
              </div>
          </div>
   <div class="info" style="height:250px;">
              ...
              <div class="title">
                <img src="/public/image/13.png" class="titleimg">
              </div>
              <div id="feiliao">
                <div style="float:left;font-family:黑体;margin-top:20px;margin-left:45px;" >
                  <h1>肥料</h1>
                </div>
                <div style="float:left;font-family:黑体;font-size:3em;margin-top:20px;color:#D1D2D3;margin-left:45px;">
                  零使用
                </div>
              </div>
              <div id="feiliaozero">
...
<!-- 图表 -->
   <div class="info" style="height:250px;">
              ...
              <div class="title">
                <img src="/public/image/12.png" class="titleimg">
              </div>
  ...
  datasets : [
    ...
    },
    {
      ...
      data : [12,11,12,6,12,11,9]
          ...
          <div class="info" style="height:250px;">
              <div class="title">
                <img src="/public/image/10.png" class="titleimg">
              </div>
              <div class="companyinfo" style="height:110px;">
      
                <img class="am-circle companyimg" src="/public/image/<?php echo ($product["kindimage"]); ?>" width="90" height="90" style="border:1px solid #D1D2D3;" />
