...
<body style="background-image:url(/public/image/tian.jpg);background-size:cover;background-repeat:no-repeat;">
		<p style="font-family:隶书;font-size:50px;color:white;margin-left:5%">南京邮电大学盐城大数据研究院农产品溯源系统</p>
	<div class="wrap" style="margin-left:60%;margin-top:15%;">

		<form method="post" name="login" action="<?php echo U('public/dologin');?>" autoComplete="off" class="js-ajax-form">
			<div class="login" style="left:200px;top:200px;">
				<ul>
					<li>
