...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('AdminPage/batch_index');?>">批次管理</a></li>
			<li><a href="<?php echo U('AdminPage/batch_add');?>">添加批次</a></li>
		</ul>
		...
		<form class="js-ajax-form" method="post">
			...
			<table class="table table-hover table-bordered table-list">
				...
				<?php if(is_array($posts)): foreach($posts as $key=>$vo): ?><tr>
					...
					<td><a href="<?php echo U('show/index/index',array('id'=>($code.$vo['productcode'])));?>" target="_blank"><?php echo ($vo["productcode"]); ?></a></td>
					<td><a href="<?php echo U('show/index/index',array('id'=>($vo['companycode'].$vo['productcode'].$vo['batchcode'])));?>" target="_blank"><?php echo ($vo["batchcode"]); ?></a></td>
					<td><span><?php echo ($vo["basename"]); ?></span></td>
					 <td><?php echo ($vo["place"]); ?></td>
					<td><?php echo ($vo["outtime"]); ?></td>
					<td><?php echo ($vo["timestamp"]); ?></td>
					<td>
						<a href="<?php echo U('AdminPage/batch_edit',array('id'=>($vo['companycode'].$vo['productcode'].$vo['batchcode'])));?>"><?php echo L('EDIT');?></a>|
						<a href="/index.php/Portal/AdminPage/batch_delete?id=<?php echo ($vo['companycode']); echo ($vo['productcode']); echo ($vo['batchcode']); ?>" class="js-ajax-delete"><?php echo L('DELETE');?></a>|
						<a href="<?php echo U('AdminPage/qrcode',array('id'=>($vo['companycode'].$vo['productcode'].$vo['batchcode'])));?>">生成二维码</a>
